...
<template>
  <header class="py-[10px] bg-[--color-white]">
    <MainContainer>
      <div class="header-inner w-full justify-between align-center grid grid-cols-[1fr,2fr,1fr]">
        ...
        <div class="flex justify-end">
          <v-divider vertical class="border-opacity-100 mr-[10px]" color="#2196F3" :thickness="2" />
